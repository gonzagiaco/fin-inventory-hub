    ...
    <div className="flex-1 p-6 lg:p-10">
      ...
      <div className="space-y-6">
        ...
        <div className="glassmorphism rounded-xl shadow-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm">
            Si tu archivo Excel contiene múltiples tablas con diferentes nombres de columnas (por ejemplo, "Descripcion"
            en una tabla y "Medida descripcion" en otra), puedes configurar todas las variantes posibles.
          </p>
          ...
          <div className="space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                En <strong>"Campos de Código"</strong> y <strong>"Campos de Nombre/Descripción"</strong>, selecciona
              ...
              <li>
                El sistema automáticamente usará <strong>la primera columna que encuentre con datos</strong> en cada
                producto
              </li>
              <li>
          ...
          <Alert>
            ...
            <AlertDescription>
              Configura todas las variantes de columnas al subir un archivo nuevo. Esto asegura que todos los productos
              tengan datos completos incluso si vienen de diferentes tablas dentro del mismo Excel.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className="glassmorphism rounded-xl shadow-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm">El sistema de búsqueda funciona tanto online como offline:</p>
          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
            <li>
              <strong>Online:</strong> Búsqueda rápida en la base de datos usando el índice optimizado
            </li>
            <li>
              <strong>Offline:</strong> Búsqueda local en los datos sincronizados
            </li>
        ...
        <div className="glassmorphism rounded-xl shadow-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm">Exporta tus pedidos agrupados por proveedor:</p>
          <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
          ...
          <Alert>
            ...
            <AlertDescription>
              El precio que se agrega al subtotal y total se evalúa según la columna seleccionada en{" "}
              <strong>"Columna de precio para carrito de pedidos"</strong> dentro de la Configuración de lista. En caso
              de no seleccionar una columna, se utilizará la <strong>"Clave de PRECIO"</strong> por defecto.
            </AlertDescription>
          </Alert>
        </div>
