...
const CollapsibleSidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed lg:sticky top-0 min-h-[100dvh] lg:h-screen bg-background/70 backdrop-blur-xl 
          border-r border-primary/20 flex flex-col p-6 z-30 transition-all duration-300
