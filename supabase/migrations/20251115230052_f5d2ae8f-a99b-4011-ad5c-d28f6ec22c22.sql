-- Crear función para UPSERT batch con actualización dual de dynamic_products y dynamic_products_index
...
BEGIN
  ...
  -- 5. DELETE productos obsoletos
  WITH new_codes AS (
    SELECT jsonb_array_elements_text(
      jsonb_agg(v_product->>'code')
    ) as code
